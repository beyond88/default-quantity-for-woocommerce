...
class Default_Quantity_For_Woocommerce {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Default_Quantity_For_Woocommerce_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Default_Quantity_For_Woocommerce_Loader. Orchestrates the hooks of the plugin.
	 * - Default_Quantity_For_Woocommerce_i18n. Defines internationalization functionality.
	 * - Default_Quantity_For_Woocommerce_Admin. Defines all hooks for the admin area.
	 * - Default_Quantity_For_Woocommerce_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Default_Quantity_For_Woocommerce_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Default_Quantity_For_Woocommerce_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Default_Quantity_For_Woocommerce_Loader    Orchestrates the hooks of the plugin.
	 */
